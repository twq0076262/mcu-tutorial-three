...
我们前边学第7章点阵 LED 的时候，可以实现上下移动，左右移动等。而对于 1602 液晶来说，也可以进行屏幕移动，实现我们想要的一些效果，那我们来用一个例程实现字符串在 1602 液晶上的左移。每个人都不要只瞪着眼看，一定要认真抄下来，甚至抄几遍，边抄边理解，要想真正学好，一定要根据我的方法来做。 
...
void main(){
    ...
    EA = 1; //开总中断
    ConfigTimer0(10); //配置 T0 定时 10 ms
    InitLcd1602(); //初始化液晶
